...
export class initTables1617797188599 implements MigrationInterface {
    name = 'initTables1617797188599'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "keys" ("id" SERIAL NOT NULL, "value" integer NOT NULL, "userId" integer, CONSTRAINT "REL_d66070b078b2628e8e2138f63e" UNIQUE ("userId"), CONSTRAINT "PK_e63d5d51e0192635ab79aa49644" PRIMARY KEY ("id"))`);
