...
export class initTables1617806096980 implements MigrationInterface {
    name = 'initTables1617806096980'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "transactions" ("id" SERIAL NOT NULL, "value" double precision NOT NULL, "userSendId" integer, "userReciveId" integer, CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "keys" ("id" SERIAL NOT NULL, "value" character varying NOT NULL, "userId" integer, CONSTRAINT "PK_e63d5d51e0192635ab79aa49644" PRIMARY KEY ("id"))`);
